...
class OrderDeleteWidget extends StatefulWidget {
  const OrderDeleteWidget({Key? key}) : super(key: key);

  @override
  State<OrderDeleteWidget> createState() => _OrderDeleteWidgetState();
}

class _OrderDeleteWidgetState extends State<OrderDeleteWidget> {
  @override
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemCount: 1,
      itemBuilder: (BuildContext p, int o) {
              ...
              child: Column(
                children: [
                  ListView.builder(
                    shrinkWrap: true,
                    itemCount: 3,
                    itemBuilder: (BuildContext t, int y) {
